...
public class ProgrammeEtudiant
{
    public static void main(String Args[]) {
        ...
        adr1 = new Adresse();
        Adresse adr2;
        adr2 = new Adresse(2,"Rue des glands","31200","Toulouse");
    ...
    /** Rôle : permet d'afficher une adresse donée
     * @param adr Adresse : adresse
     */
    public static void afficherAdresse(Adresse adr) {
        System.out.println("L'adresse de l'étudiant est :" + adr.numRue + " " + adr.nomRue + " " + adr.codeP + " " + adr.nomVille);
    }
}
